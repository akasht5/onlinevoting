      ...
      <div class="row ">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4 main-content">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom container">
            <p class="lead">Admin / View Election</p>
          </div>
          <div class="main-body container">
            ...
            <table class="table table-bordered table-striped">
              ...
              <tr>
                <td>10</td>
                <td>Assembly Constituency of Jharkhand 19-20</td>
                <td>104</td>
                <td>70</td>
                <td>12/3/2017</td>
                <td>3/4/2017</td>
                <td><button type="button" class="btn btn-success">Edit</button></td>
                <td><button type="button" class="btn btn-danger">End</button></td>
              </tr>
              <tr>
                <td>11</td>
                <td>Parliament Constituency of Maharashtra 19-20</td>
                <td>215</td>
                <td>150</td>
                <td>10/8/2017</td>
                <td>28/8/2017</td>
