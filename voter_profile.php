      ...
      <div class="row ">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4 main-content">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <p class="lead">Voter / Dashboard</h1>
          </div>
          <div class="jumbotron">
            <h3>Welcome John Williams!</h3>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corporis repellat odit quae, aut quod.</p>
          </div>
