    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 ml-auto mr-auto card-form">
                    ...
                    <form action="voter_profile.php">
                        <div class="form-group">
                            <h6>Email Address</h6>
                            <input type="email" name="username" id="" class="form-control" placeholder="Email Address">
                        </div>
                        <div class="form-group">
                            <h6>Password</h6>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <a href="voter_registration.php" class="ml-4">Don,t have an account! Register Here</a>
                        </div>
                    </form>
